...
A modern, full-featured hotel booking system built with PHP, MySQL, and JavaScript. Features a beautiful gradient UI, secure authentication, payment processing, and comprehensive booking management.
